...
struct PipelineEvent
{
    ...
    QString       eventType;       // ex: "speech_started", "stt_partial", "tts_chunk", ...
...
struct ModuleStatus
{
    ...
    QString        lastEvent;          // dernier event_type
...
public:
    ...
    void postEvent(PipelineModule module, const QString &eventType,
...
//
//  Usage :  PIPELINE_EVENT(PipelineModule::STT, "partial_transcript",
