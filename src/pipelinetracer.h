...
private:
    ...
    qint64 firstEventMs(const InteractionTrace &trace, const QString &module, const QString &eventType) const;
    qint64 lastEventMs(const InteractionTrace &trace, const QString &module, const QString &eventType) const;
    int countEvents(const InteractionTrace &trace, const QString &module, const QString &eventType) const;
