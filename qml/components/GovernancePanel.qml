...
Rectangle {
    ...
    property var validations: []      // { timestamp, rule, result, detail }
    property var auditLog: []         // { timestamp, action, actor, outcome }
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    RowLayout {
                        ...
                        readonly property var v: root.validations[index] || {}
                        ...
                        Rectangle {
                            ...
                            color: root.resultColor(v.result || "pass")
                        }
                ...
                Text {
                    ...
                    font.pixelSize: Theme.fontSmall
                    color: Theme.textMuted
                    visible: root.validations.length === 0
                }
            }
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    RowLayout {
                        ...
                        readonly property var a: root.auditLog[index] || {}
                        ...
                        Rectangle {
                            ...
                            height: 16; radius: 3
                            color: a.outcome === "ok" ? Qt.rgba(Theme.success.r, Theme.success.g, Theme.success.b, 0.15)
                                 : a.outcome === "denied" ? Qt.rgba(Theme.error.r, Theme.error.g, Theme.error.b, 0.15)
                                 : Qt.rgba(Theme.warning.r, Theme.warning.g, Theme.warning.b, 0.15)

                            Text {
                                id: outcomeLabel
                                anchors.centerIn: parent
                                text: (a.outcome || "ok").toUpperCase()
                                font.family: Theme.fontMono
                                font.pixelSize: 9
                                font.weight: Font.Bold
                                color: a.outcome === "ok" ? Theme.success
                                     : a.outcome === "denied" ? Theme.error
                                     : Theme.warning
                            }
                        }
                    }
                ...
                Text {
                    ...
                    font.pixelSize: Theme.fontSmall
                    color: Theme.textMuted
                    visible: root.auditLog.length === 0
                }
            }
        }
    }
