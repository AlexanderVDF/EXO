...
//  Durée + état + animation glow premium
// ═══════════════════════════════════════════════════════
...
Rectangle {
    ...
    // ── Propriété: mode compact pour embedding ──
                    ...
                    RowLayout {
                        ...
                        Item {
                            ...
                            Rectangle {
                                ...
                                border.color: Qt.lighter(layerColor(lstate), 1.4)
                            ...
                            Rectangle {
                                ...
                                color: "transparent"
                                border.width: 2
                                border.color: layerColor(lstate)
                        ...
                        Rectangle {
                            ...
                            color: {
                                if (lstate === "active")
                                    return Qt.rgba(layerColor(lstate).r, layerColor(lstate).g, layerColor(lstate).b, 0.08)
                                if (lstate === "processing")
                                    return Qt.rgba(layerColor(lstate).r, layerColor(lstate).g, layerColor(lstate).b, 0.06)
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    color: Qt.rgba(layerColor(lstate).r, layerColor(lstate).g, layerColor(lstate).b, 0.2)
