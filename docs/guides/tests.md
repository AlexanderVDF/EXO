> 🧭 [Index](../README.md) → [Guides](../README.md#-guides-techniques--guides) → tests.md
...
- [Prérequis](#prérequis)
  - [C++](#c)
  - [Python](#python)
- [Tests C++ (Qt Test)](#tests-c-qt-test)
  - [Liste des tests](#liste-des-tests)
  - [Architecture des tests C++](#architecture-des-tests-c)
  - [Exécution](#exécution)
- [Tests Python (pytest)](#tests-python-pytest)
  - [Liste des fichiers de test](#liste-des-fichiers-de-test)
  - [Fixtures (conftest.py)](#fixtures-conftestpy)
  - [Exécution](#exécution)
- [Convention de nommage](#convention-de-nommage)
- [Ajout d'un nouveau test](#ajout-dun-nouveau-test)
  - [C++](#c)
  - [Python](#python)
- [CI locale](#ci-locale)
...
La bibliothèque `exo_testlib` compile tous les modules C++ testables en une lib statique partagée par tous les tests.
Chaque test est un exécutable indépendant.
