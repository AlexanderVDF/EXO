> 🧭 [Index](../README.md) → [Architecture](../README.md#-architecture--spécifications--core) → architecture_modules.md
...
- [Ownership mémoire](#ownership-mémoire)
- [Exposition QML](#exposition-qml)
