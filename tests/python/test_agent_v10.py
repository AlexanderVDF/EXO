...
sys.path.insert(0, str(_root / "python" / "nlu"))
sys.path.insert(0, str(_root / "python" / "planner"))
sys.path.insert(0, str(_root / "python" / "executor"))
sys.path.insert(0, str(_root / "python" / "verifier"))
sys.path.insert(0, str(_root / "python" / "context"))
...
class TestTaskMemory:
    ...
    def _make_memory(self):
        ...
        return TaskMemory(persist_path="")  # no persistence
