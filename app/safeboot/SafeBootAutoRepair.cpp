...
void SafeBootAutoRepair::processRepairQueue()
{
    ...
    // Prochain service avec un petit délai
    QTimer::singleShot(kRepairDelayMs, this, &SafeBootAutoRepair::processRepairQueue);
}
...
bool SafeBootAutoRepair::restartService(const QString &serviceName)
{
    ...
    env.insert(QStringLiteral("EXO_COSYVOICE_MODELS"), ssd + "/models/CosyVoice2-0.5B");
    env.insert(QStringLiteral("COSYVOICE_ROOT"),       ssd + "/CosyVoice");
