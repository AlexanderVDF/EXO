...
struct LatencySnapshot
{
    ...
    qint64 sttLatency() const { return tSttFinal - tSttStart; }
    qint64 llmFirstTokenLatency() const { return tLlmFirstToken - tLlmRequest; }
    qint64 llmTotalLatency() const { return tLlmComplete - tLlmRequest; }
    qint64 ttsLatency() const { return tTtsFirstAudio - tLlmFirstToken; }
    qint64 perceivedLatency() const { return tTtsFirstAudio - tSttFinal; }
    qint64 endToEnd() const { return tResponseDone - tSttStart; }
